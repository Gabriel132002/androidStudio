...
public class TelaApresentacao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVoltar = findViewById(R.id.btnPrincipalVoltar);
        ...
        for(int valor=0; valor<64; valor++){
            ...
            btn[valor].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(Valor==v){
                        Intent i = new Intent(TelaApresentacao.this, Tela2.class);
        ...
        btnVoltar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TelaApresentacao.this, MainActivity.class);
